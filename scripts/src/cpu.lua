...
if CPUS["H8"] then
	files {
		...
		MAME_DIR .. "src/devices/cpu/h8/h8_dac.cpp",
		MAME_DIR .. "src/devices/cpu/h8/h8_dac.h",
		...
		MAME_DIR .. "src/devices/cpu/h8/h8_host.cpp",
		MAME_DIR .. "src/devices/cpu/h8/h8_host.h",
